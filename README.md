...
- The India layer is local and stable; hover reveals a state name and click opens its discovery layer.
- South India uses district-level exploration, with Karnataka rendered from a local interactive SVG map.
